...
class MatchFactoryImpl implements IMatchFactory
{
  ...
  @NotNull
  @Override
  public IQueryBuilder interpretMatch(@NotNull String pMatchType, @NotNull String... pMatchDetails) throws Exception
  {
    try
    {
      ...
      switch (pMatchType)
      {
        case EqualMatch.TYPE:
          return new EqualMatch(pMatchDetails[0], pMatchDetails[1]);
    ...
    {
      throw new IllegalArgumentException("Wrong arguments for match " + pMatchType + ": " + Arrays.toString(pMatchDetails));
    }
  }
