 ...
 */
@ApplicationScoped
public class MediaMarktProductCrawler implements IProductCrawler
{
  private static final Logger _LOGGER = LoggerFactory.getLogger(MediaMarktProductCrawler.class);
  ...
  {
    return ListUtil.of("https://www.mediamarkt.de/de/category/_pc-notebook-software-661012.html");
  }
